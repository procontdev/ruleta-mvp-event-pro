...
// Puedes ajustar por .env: VITE_DASHBOARD_REFRESH_MS=5000
...
export default function Dashboard() {
  ...
  // Polling en vivo
  useEffect(() => {
    if (!live || eventId == null) return;
    const t = setInterval(() => load(eventId), REFRESH_MS);
  ...
  return (
    <div style={s.container}>
      ...
      <div style={{ display:'flex', gap:8, alignItems:'center', marginBottom:12 }}>
        ...
        <button style={s.small} onClick={() => eventId && load(eventId)} disabled={loading}>
